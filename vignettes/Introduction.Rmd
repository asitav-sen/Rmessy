...
Some parameters of the individual functions can be controlled by mode, norm, direc and loops which indicate mode, nomalized, direction and loops respectively.
